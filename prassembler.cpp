...
PRassembler::PRassembler(std::map<std::string, std::string>* inst)
{
    instructions = inst;
}

std::vector<std::string> PRassembler::tokenize(std::string str, std::string separator){
...
std::vector<std::string> PRassembler::fileToList(std::string filename){
    std::ifstream input;
...
std::string PRassembler::fileToString(std::string filename){
...
void PRassembler::getDataAndCode(std::string &text,std::string &data, std::string &code){
...
std::vector<std::tuple<int,std::string,std::vector<std::string>,bool>> PRassembler::first_pass(std::string &code){
...
std::vector<std::tuple<int,std::string>> PRassembler::handleDataSection(std::string &data){
    std::cout << "Handling data section\n";
    LC++;
...
std::vector<std::tuple<int,std::string>> PRassembler::second_pass( std::vector<std::tuple<int,std::string,std::vector<std::string>,bool>> &fp){
...
std::vector<std::tuple<int,std::string>> PRassembler::assemble(std::string filename, int memstart){
    ...
    /*
    std::cout << "L     I     N     E     S      +      D      A      T      A\n";
    for(unsigned int i =0; i<final.size(); i++){
        std::cout << std::get<0>(final[i]) << " : "<< std::get<1>(final[i]) << "\n";
    }*/
